    ...
    <div class="col-md-9 ml-auto mr-auto">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Estimate Details</h6>
            </div>
            <div class="card-body">
                {{-- form starts here --}}
                <form method="post" action="{{action('EstimateController@store')}}" autocomplete="off"
                    ...
                    <div class="row py-3">
                        ...
                        <div class="col-9 text-left">
                            {{$purchaseRequest->uuid}} <br> <input type="hidden" name="purchaseRequest_uuid" value="{{$purchaseRequest->uuid}}">
                            {{$purchaseRequest->created_at->format('Y-m-d')}} <br>
                    ...
                    <div class="row  col-md-12">
                        <label class="col-sm-2 col-form-label text-md-right">Expiry Date</label>
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group">
